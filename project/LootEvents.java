...
public class LootEvents {
    ...
    public void lootevents(){
        ...
        if(lootchance == 1 && weapon < 5){
            JOptionPane.showMessageDialog(null,"You found a rusty short sword, you pick it up");
            player.setWeapon(5);
        }
        else if(lootchance == 2 && weapon < 10){
            JOptionPane.showMessageDialog(null,"You found a spear, you pick it up");
            player.setWeapon(5);
        }
        else if(lootchance == 3 && weapon < 15){
            JOptionPane.showMessageDialog(null,"You found a fine short sword, you pick it up");
            player.setWeapon(5);
        }
        else if(lootchance == 4 && weapon < 20){
            JOptionPane.showMessageDialog(null,"You found a fine long sword, you pick it up");
            player.setWeapon(5);
        }
        else if(lootchance == 5 && weapon < 25){
            JOptionPane.showMessageDialog(null,"You found an enchanted long sword longsword stuck on a rock, you pull it out of the rock");
            player.setWeapon(5);
        }
        else if(lootchance == 6 && health < 50){
            JOptionPane.showMessageDialog(null,"You found Rusty Armor of a fallen soldier, you take it");
            player.setHealth(50);
        }
        else if(lootchance == 7 && health < 100){
            JOptionPane.showMessageDialog(null,"You found Armor of a fallen soldier, you take it");
